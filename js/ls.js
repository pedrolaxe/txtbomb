(function() {
  ...
  Bomb = (function() {
    ...
    Bomb.prototype.drop = function() {
      ...
      this.bomb.style['background'] = '#339933';
  ...
  Explosion = (function() {
    ...
    function Explosion() {
      ...
      if (confirmation != null) {
        ...
        this.confirmation.innerHTML = "<span style='font-weight:bold;'>Bomba de Letras CSS Carregada</span> Clique e destrua qualquer pagina " + (document.title.substring(0, 50));
        ...
        setTimeout(function() {
          ...
          return setTimeout(function() {
            _this.confirmation.innerHTML = "Desenvolvido por <a href='http://www.facebook.com/pedrolaxe'>Pedro Laxe</a>";
